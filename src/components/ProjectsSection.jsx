...
const projects = [
  {
    id: 1,
    title: "A R Mercerisers — Textile Manufacturer",
    description:
      "A luxury-editorial website for a premium textile manufacturer. Built with a cinematic design system featuring paper-grain textures, smooth scroll animations, and a warm alabaster–charcoal–gold palette. Deployed on Vercel.",
  ...
  {
    id: 2,
    title: "CrowdSafe.ai — AI Crowd Monitoring",
    description:
      "An AI-driven crowd safety platform featuring real-time anomaly detection powered by YOLOv8, live spatial heatmaps, and a monitoring dashboard. Full-stack pipeline with a Python AI backend and React frontend for actionable crowd intelligence.",
    tags: ["REACT", "PYTHON", "YOLOV8", "FLASK", "RABBITMQ", "FASTAPI", "SOCKET.IO", "POSTGRESQL"],
  ...
  },
  {
    ...
    tags: ["PYTHON", "TENSORFLOW", "KERAS", "NUMPY", "PANDAS", "MATPLOTLIB", "SCIKIT-LEARN"],
              ...
              <div className="flex border-t-1 border-ink-black pt-6 gap-4">
                ...
                {project.liveUrl ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="newsprint-btn newsprint-btn-outline p-2 transition-all hover:bg-editorial-red hover:text-white hover:border-editorial-red"
                  >
