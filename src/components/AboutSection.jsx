        ...
        <div className="lg:col-span-4 border-l-1 border-ink-black pl-0 lg:pl-12 flex flex-col gap-12">
          <div>
            ...
            <div className="flex flex-col">
              {[
                { role: "Intern", company: "AheadOne Technologies Private Limited", period: "07/2025 — 12/2025", desc: "Developed and enhanced a dynamic web application using Angular and Spring Boot, implementing modular and scalable features." }
              ].map((item, i) => (
